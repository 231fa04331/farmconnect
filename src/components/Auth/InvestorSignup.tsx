...
import { Eye, EyeOff, Building, DollarSign, Mail, User, Phone, Briefcase } from 'lucide-react';
...
function InvestorSignup() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Prepare data for backend (match your auth endpoint)
      const userData = {
  ...
  return (
    <AuthLayout
      ...
      subtitle="Start investing in sustainable agriculture"
      showBackButton={true}
    >
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="space-y-4">
          <div className="flex items-start">
            ...
            />
            <label htmlFor="accreditedInvestor" className="ml-3 text-sm text-gray-600">
